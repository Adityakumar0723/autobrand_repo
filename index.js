...
app.get("/", (req, res) => {
    res.send("Welcome to the AutoBrand API welcome back ondemand is the father of ai silence please aditya is owner of this website so why you are waiting so grab this opertunity  . ");
});
